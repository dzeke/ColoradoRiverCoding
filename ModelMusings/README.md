...
## Model Structure
**Spreadsheet**:
 * Rows represent the components of an interactive water budget for a combined Lake Powell-Lake Mead system. Interactive mean the players enter some components of the water budget. The different types of components (cell fill) are:
...
1. ~ 1 to 2 hours. If needed, split over multiple periods.
...
## Requested Feedback
Please share your feedback about this numerical model -- things you like, things to improve.
