...
dfKeyTraceLabels <- data.frame(Label = c("Protect", "Public Pool", "Lake Mead\nConservation\nAccounts", "Deficit Mindset"),
...
dfKeyTraceLabels$xPosition[2] <- 2011
...
# Figure 4. Mead Storage over time with conservation accounts
